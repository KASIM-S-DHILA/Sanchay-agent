    ...
    projects: [
      {
        ...
        test: {
          ...
          include: [
            ...
            "evals/user-preferences.eval.test.ts",
          ],
        },
      },
      {
        ...
        test: {
          ...
          include: [
            ...
            "evals/user-preferences-flow.eval.test.ts",
            "evals/e2e.eval.test.ts",
            "evals/graceful-failure.eval.test.ts",
            "evals/truth-pass.eval.test.ts",
          ],
        },
      },
    ],
